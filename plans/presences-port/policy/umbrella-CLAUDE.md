...
Three independent git repos live side by side under this (non-git) umbrella dir: `levelup_backend/` (Flask), `levelup_frontend/` (npm-workspaces monorepo — see its own CLAUDE.md), `levelup_issue_bot/`. Spec tree in `specs/` (markdown, `_index.md` + feature dirs).
...
Backend commands live in `levelup_backend/CLAUDE.md`; E2E details live in `levelup_frontend/apps/web/CLAUDE.md`.
...
breaks a ported screen: `levelup_frontend/CLAUDE.md`.
