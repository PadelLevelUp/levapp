...
- [2026-09-13 — Rolling production back: what is possible and what is not](2026-09-13-prod-rollback-procedure.md) — PAD-338: per-commit image tags and keep-last-three replace the success-path prune; the three failure cases; after a migration has applied there is no rollback, only restore-then-redeploy, which depends on the unproven backup
