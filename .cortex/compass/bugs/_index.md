...
- [B-065](B-065-ios-day-sheet-without-corners-or-shadow.md) — the iOS calendar day sheet rendered flat: `shadow-lg` casts downward and `overflow-hidden` clips a view's own shadow on iOS, so the 20pt corners had nothing to show against (missing-criterion, low, triaged in PAD-286)
