...
# B-026 — Message send/edit/delete/react never check the caller is a participant
...
**Criteria added:** "A non-participant cannot post into a conversation (B-026)" and
