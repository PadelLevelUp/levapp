...
- `auth/` — Authentication & User Management (10 leaves; `auth.register` rewritten and `auth.coach-approval` added 2026-09-06, PAD-210; `auth.landing-page` added 2026-09-07)
