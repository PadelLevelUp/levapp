...
- `evaluations.sharing` — implementing (PAD-402, owner-decided 2026-09-22) — choose, preview,
  share, un-share; one thread message, no push
- `evaluations.student-view` — implementing (PAD-402) — what a player sees; the one job of the
